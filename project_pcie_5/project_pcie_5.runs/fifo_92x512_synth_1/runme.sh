...
HD_PWD='/home/asautaux/yarr/project_pcie_5/project_pcie_5.runs/fifo_92x512_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_92x512.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fifo_92x512.tcl
