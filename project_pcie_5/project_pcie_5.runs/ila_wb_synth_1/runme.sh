...
HD_PWD='/home/asautaux/yarr/project_pcie_5/project_pcie_5.runs/ila_wb_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_wb.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ila_wb.tcl
