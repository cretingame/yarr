...
`define custom_part_width
    parameter TRRD             =    5000; // tRRD       ps     Active bank a to Active bank b command time
    ...
    // Refresh - 1Gb
    parameter TRFC_MIN         =  161350; // tRFC       ps    Refresh to Refresh Command interval minimum value
