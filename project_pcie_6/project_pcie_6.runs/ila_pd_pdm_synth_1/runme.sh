...
HD_PWD='/home/asautaux/yarr/project_pcie_6/project_pcie_6.runs/ila_pd_pdm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_pd_pdm.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ila_pd_pdm.tcl
