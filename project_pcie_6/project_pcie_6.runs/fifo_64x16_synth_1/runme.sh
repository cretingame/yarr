...
HD_PWD='/home/asautaux/yarr/project_pcie_6/project_pcie_6.runs/fifo_64x16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_64x16.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fifo_64x16.tcl
