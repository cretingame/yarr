...
HD_PWD='/home/asautaux/yarr/project_pcie_5/project_pcie_5.runs/ila_l2p_dma_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_l2p_dma.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ila_l2p_dma.tcl
