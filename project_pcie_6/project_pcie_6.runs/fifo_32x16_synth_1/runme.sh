...
HD_PWD='/home/asautaux/yarr/project_pcie_6/project_pcie_6.runs/fifo_32x16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_32x16.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fifo_32x16.tcl
