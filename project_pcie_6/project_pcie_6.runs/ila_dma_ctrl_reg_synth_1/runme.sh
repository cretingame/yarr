...
HD_PWD='/home/asautaux/yarr/project_pcie_5/project_pcie_5.runs/ila_dma_ctrl_reg_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_dma_ctrl_reg.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ila_dma_ctrl_reg.tcl
