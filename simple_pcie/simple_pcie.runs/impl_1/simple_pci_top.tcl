...
set rc [catch {
  ...
  write_bitstream -force simple_pci_top.bit -bin_file
  catch { write_sysdef -hwdef simple_pci_top.hwdef -bitfile simple_pci_top.bit -meminfo simple_pci_top.mmi -file simple_pci_top.sysdef }
