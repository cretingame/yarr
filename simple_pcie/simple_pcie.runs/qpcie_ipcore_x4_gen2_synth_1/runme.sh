...
HD_PWD='/home/asautaux/yarr/simple_pcie/simple_pcie.runs/qpcie_ipcore_x4_gen2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log qpcie_ipcore_x4_gen2.vds -m64 -mode batch -messageDb vivado.pb -notrace -source qpcie_ipcore_x4_gen2.tcl
