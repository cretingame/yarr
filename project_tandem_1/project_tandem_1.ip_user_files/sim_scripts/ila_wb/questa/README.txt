...
#
# Generated by export_simulation on Fri Mar 31 15:15:07 PDT 2017
#
################################################################################
...
switch to the './ila_wb.sh' script.
...
./ila_wb.sh -noclean_files

For more information on the script, please type './ila_wb.sh -help'.
