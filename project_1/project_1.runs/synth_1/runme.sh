...
HD_PWD='/home/asautaux/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_counter.vds -m64 -mode batch -messageDb vivado.pb -notrace -source simple_counter.tcl
