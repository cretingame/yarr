...
#
# Generated by export_simulation on Tue Oct 18 16:59:36 PDT 2016
#
################################################################################
...
switch to the './axi_mm2s_mapper_0.sh' script.

./axi_mm2s_mapper_0.sh -reset_run
...
./axi_mm2s_mapper_0.sh -noclean_files

For more information on the script, please type './axi_mm2s_mapper_0.sh -help'.
