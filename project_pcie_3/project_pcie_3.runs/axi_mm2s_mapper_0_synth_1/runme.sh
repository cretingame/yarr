...
HD_PWD='/home/asautaux/yarr/project_pcie_3/project_pcie_3.runs/axi_mm2s_mapper_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_mm2s_mapper_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source axi_mm2s_mapper_0.tcl
