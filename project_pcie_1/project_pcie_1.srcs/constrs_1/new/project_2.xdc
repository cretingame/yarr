...
create_clock -period 10.000 -name sys_clk -waveform {0.000 5.000} [get_nets -hierarchical *sys_clk*]

set_clock_groups -name sys_clk -asynchronous -group [get_clocks {pcie_clk_p sys_clk}]

set_property IOSTANDARD LVCMOS15 [get_ports sys_rst_n_i]
set_property PACKAGE_PIN L23 [get_ports sys_rst_n_i]
