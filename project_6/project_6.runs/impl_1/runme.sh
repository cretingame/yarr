...
HD_PWD='/home/asautaux/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_counter.vdi -applog -m64 -messageDb vivado.pb -mode batch -source simple_counter.tcl -notrace
