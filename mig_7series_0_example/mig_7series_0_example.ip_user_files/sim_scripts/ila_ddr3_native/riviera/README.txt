...
#
# Generated by export_simulation on Tue May 02 16:18:16 PDT 2017
#
################################################################################
...
switch to the './ila_ddr3_native.sh' script.

./ila_ddr3_native.sh -reset_run
...
./ila_ddr3_native.sh -noclean_files

For more information on the script, please type './ila_ddr3_native.sh -help'.
