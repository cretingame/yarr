...
elaborate()
{
  opts="-load "/proj/xbuilds/released/2015.4/2015.4_1118_2/installs/lin64/Vivado/2015.4/lib/lnx64.o/libxil_vcs.so:xilinx_register_systf" -full64 -debug_pp -t ps -licqueue -l elaborate.log"
